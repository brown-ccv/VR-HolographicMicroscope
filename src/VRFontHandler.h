...
class VRFontHandler
	{
		public:
			...
			void renderMultiLineTextBox(std::vector<std::string> text, double x, double y, double z, double width, double height, TextAlignment alignment = CENTER, bool rotateY = false);
